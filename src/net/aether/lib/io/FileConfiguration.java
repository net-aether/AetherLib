...
public interface FileConfiguration {
	 ...
	 * It is recommended, that {@link #toString()} would return the exact same value, but this might not always be the case.<br>
	 * Please look into the javadoc of the implementation
	 * @return
	 */
	 ...
	 */
	public default boolean isFileSupported(File fiel) { return true; }
