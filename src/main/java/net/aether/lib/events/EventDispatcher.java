...
public interface EventDispatcher {
	...
	/**
	 * Registers a single Consumer as an EventListener, that listens for events with the <b>eventType</b> class.
	 * @param eventType the class to listen for
	 * @param listener the recipient of the event
	 */
	<T> void register(Class<T> eventType, Consumer<T> listener);
	 ...
	 */
	void registerClass(Class<?> listenerClass);
	 ...
	 */
	void registerObject(Object listenerObject);
